defmodule RetoElixir.Utils.CustomTelemetryTest do
  alias RetoElixir.Utils.CustomTelemetry
  use ExUnit.Case
  ...
  test "handle_custom_event adds service name to metadata" do
    ...
    Application.put_env(:reto_elixir, :service_name, service_name)
  ...
  test "execute_custom_event emits the correct event with default metadata" do
    metric = [:custom, :event]
    value = 200
    expected_metadata = %{service: "reto_elixir_test"}
