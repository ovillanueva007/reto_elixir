defmodule RetoElixir.Config.ConfigHolder do
  use GenServer
  alias RetoElixir.Config.AppConfig
  @table_name :reto_elixir_config
  ...
  defp load_additional_properties(%AppConfig{} = config) do
    Application.get_env(:reto_elixir, :config_loaders, [])
...
defmodule RetoElixir.Config.ConfigHolder.PropertiesLoaderBehaviour do
  alias RetoElixir.Config.AppConfig
